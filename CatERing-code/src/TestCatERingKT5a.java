...
public class TestCatERingKT5a {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("\nTEST DELETE TASKS");
            CatERing.getInstance().getKitchenTaskManager().deleteKitchenTask(ktask2);
            CatERing.getInstance().getKitchenTaskManager().deleteKitchenTask(ktask3);
            System.out.println(sumSheet.toString());

            System.out.println("\nTEST  INSERT INFO");
            CatERing.getInstance().getKitchenTaskManager().insertMoreInfo(ktask4, "2 chili", "1,5 ore");
            CatERing.getInstance().getKitchenTaskManager().insertMoreInfo(ktask1, "2 chili", "1,5 ore");
