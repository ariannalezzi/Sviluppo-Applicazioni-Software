...
public class TestCatERingKT1a {
    public static void main(String[] args) {
        try {
            ...
            SummarySheet sumSheet2 = CatERing.getInstance().getKitchenTaskManager().createSummarySheet("Aperitivo", 1, 3);
            System.out.println(sumSheet.toString());
            System.out.println(sumSheet2.toString());


            System.out.println("\nTEST CHOOSE SUMMARY SHEET");
            CatERing.getInstance().getKitchenTaskManager().openSummary(sumSheet);
