...
public class TestCatERingKT1b {
    public static void main(String[] args) {
        try {
            ...
            SummarySheet sumSheet2 = CatERing.getInstance().getKitchenTaskManager().createSummarySheet("Brunch", 2, 1);
            ...
            System.out.println("\nTEST RESTORE SUMMARY SHEET");
            SummarySheet sumSheetRES = CatERing.getInstance().getKitchenTaskManager().restoreSummarySheet(sumSheet2);
            System.out.println(sumSheet.toString());
